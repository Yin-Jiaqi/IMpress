 ...
 */
// forward
static inline void ntt8192_ct_std2rev(ap_int<512> *a) {
  ntt_ct_std2rev(a, 8192, ntt8192_omega_powers_rev);
}

// inverse
static inline void intt8192_ct_rev2std(ap_int<512> *a) {
 ...
 */
extern void ntt8192_int_product(ap_int<512> *c, ap_int<512> *a, ap_int<512> *b);
