...
`define AUTOTB_DUT      ntt8192_int_product
`define AUTOTB_DUT_INST AESL_inst_ntt8192_int_product
`define AUTOTB_TOP      apatb_ntt8192_int_product_top
`define AUTOTB_LAT_RESULT_FILE "ntt8192_int_product.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "ntt8192_int_product.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_ntt8192_int_product_top
...
`define AUTOTB_TVIN_gmem  "./c.ntt8192_int_product.autotvin_gmem.dat"
`define AUTOTB_TVIN_c  "./c.ntt8192_int_product.autotvin_c.dat"
`define AUTOTB_TVIN_a  "./c.ntt8192_int_product.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.ntt8192_int_product.autotvin_b.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.ntt8192_int_product.autotvin_gmem.dat"
`define AUTOTB_TVIN_c_out_wrapc  "./rtl.ntt8192_int_product.autotvin_c.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.ntt8192_int_product.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.ntt8192_int_product.autotvin_b.dat"
`define AUTOTB_TVOUT_gmem  "./c.ntt8192_int_product.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.ntt8192_int_product.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_gmem = 24576;
