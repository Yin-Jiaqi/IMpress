...
if {[file isfile ntt8192_int_product.autotvin.dat]} {
	file delete -force ntt8192_int_product.autotvin.dat
}

if {[file isfile ntt8192_int_product.autotvout.dat]} {
	file delete -force ntt8192_int_product.autotvout.dat
}
