...
//------------------------Parameter----------------------
`define TV_IN_gmem "../tv/cdatafile/c.ntt8192_int_product.autotvin_gmem.dat"
`define TV_OUT_gmem "../tv/rtldatafile/rtl.ntt8192_int_product.autotvout_gmem.dat"
 parameter gmem_ADDR_BITWIDTH = 32'd 64;
 parameter gmem_AWUSER_BITWIDTH = 32'd 1;
 parameter gmem_DATA_BITWIDTH = 32'd 512;
...
parameter gmem_C_DATA_BITWIDTH = 32'd 512;
parameter gmem_mem_depth = 32'd 24576;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("/home/asyam/Desktop/NTT/tfhe-ntt/HE-Multiplication-Million-bit-Mul-512-1024/HE_level_NTT_large_int_mul/ntt8192_int_product/solution1/sim/verilog/AESL_axi_master_gmem.v: Write request address %d exceed AXI master gmem array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("/home/asyam/Desktop/NTT/tfhe-ntt/HE-Multiplication-Million-bit-Mul-512-1024/HE_level_NTT_large_int_mul/ntt8192_int_product/solution1/sim/verilog/AESL_axi_master_gmem.v: Read request address %d exceed AXI master gmem array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
