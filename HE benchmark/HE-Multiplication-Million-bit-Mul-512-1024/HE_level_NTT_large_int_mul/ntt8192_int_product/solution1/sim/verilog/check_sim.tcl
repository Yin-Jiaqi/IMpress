...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ntt8192_int_product.autotvin_gmem.dat"
         "c.ntt8192_int_product.autotvin_c.dat"
         "c.ntt8192_int_product.autotvin_a.dat"
         "c.ntt8192_int_product.autotvin_b.dat"
         "c.ntt8192_int_product.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ntt8192_int_product.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
