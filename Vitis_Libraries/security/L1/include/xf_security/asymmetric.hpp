...
//std::cout << "inputModulus: " << inputModulus << std::endl;
...
//std::cout << "tmp: " << tmp << std::endl;
     ...
     */
    void process(ap_uint<N> message, ap_uint<N> mPrime, ap_uint<N>& result) {
        result = xf::security::internal::modularExp<N, L>(message, exponent, modulus, mPrime, rMod);
    }
};
