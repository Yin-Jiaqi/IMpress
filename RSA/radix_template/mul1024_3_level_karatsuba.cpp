...
template <int RADIX>
ap_uint<2*128> PP_0_0_0_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*129> PP_0_0_1_default(ap_uint<129> in0, ap_uint<129> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*128> PP_0_0_2_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
ap_uint<2*256> PP_0_0_karatsuba(ap_uint<256> in0, ap_uint<256> in1) {
    ...
    ap_uint<256> m0 = PP_0_0_0_default<RADIX>(in0_low, in1_low);
    ap_uint<256> m1 = PP_0_0_2_default<RADIX>(in0_up, in1_up);
    ap_uint<256/2+1> sa = in0_low + in0_up;
    ap_uint<256/2+1> sb = in1_low + in1_up;
    ap_uint<256+2> m2 = PP_0_0_1_default<RADIX>(sa, sb);
...
template <int RADIX>
ap_uint<2*128> PP_0_1_0_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*129> PP_0_1_1_default(ap_uint<129> in0, ap_uint<129> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*128> PP_0_1_2_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
ap_uint<2*257> PP_0_1_karatsuba_odd(ap_uint<257> in0, ap_uint<257> in1) {
    ...
    ap_uint<257-1> m0 = PP_0_1_0_default<RADIX>(in0_low, in1_low);
    ap_uint<257-1> m1 = PP_0_1_2_default<RADIX>(in0_up, in1_up);
    ap_uint<(257+1)/2> sa = in0_low + in0_up;
    ap_uint<(257+1)/2> sb = in1_low + in1_up;
    ap_uint<257+1> m2 = PP_0_1_1_default<RADIX>(sa, sb);
...
template <int RADIX>
ap_uint<2*128> PP_0_2_0_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*129> PP_0_2_1_default(ap_uint<129> in0, ap_uint<129> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*128> PP_0_2_2_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
ap_uint<2*256> PP_0_2_karatsuba(ap_uint<256> in0, ap_uint<256> in1) {
    ...
    ap_uint<256> m0 = PP_0_2_0_default<RADIX>(in0_low, in1_low);
    ap_uint<256> m1 = PP_0_2_2_default<RADIX>(in0_up, in1_up);
    ap_uint<256/2+1> sa = in0_low + in0_up;
    ap_uint<256/2+1> sb = in1_low + in1_up;
    ap_uint<256+2> m2 = PP_0_2_1_default<RADIX>(sa, sb);
    ap_uint<256+1> t0 = m0 + m1;
    ap_uint<256+2> t1 = m2 - t0;
...
template <int RADIX>
ap_uint<2*128> PP_1_0_0_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*129> PP_1_0_1_default(ap_uint<129> in0, ap_uint<129> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*128> PP_1_0_2_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
ap_uint<2*256> PP_1_0_karatsuba(ap_uint<256> in0, ap_uint<256> in1) {
    ...
    ap_uint<256> m0 = PP_1_0_0_default<RADIX>(in0_low, in1_low);
    ap_uint<256> m1 = PP_1_0_2_default<RADIX>(in0_up, in1_up);
    ap_uint<256/2+1> sa = in0_low + in0_up;
    ap_uint<256/2+1> sb = in1_low + in1_up;
    ap_uint<256+2> m2 = PP_1_0_1_default<RADIX>(sa, sb);
    ap_uint<256+1> t0 = m0 + m1;
    ap_uint<256+2> t1 = m2 - t0;
...
template <int RADIX>
ap_uint<2*128> PP_1_1_0_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*129> PP_1_1_1_default(ap_uint<129> in0, ap_uint<129> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*128> PP_1_1_2_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
ap_uint<2*257> PP_1_1_karatsuba_odd(ap_uint<257> in0, ap_uint<257> in1) {
    ...
    ap_uint<(257-1)/2> in1_up = i1_up >> ((257-1)/2);
    ap_uint<(257-1)/2> in1_low = (i1_up << ((257-1)/2)) >> ((257-1)/2);
    ap_uint<257-1> m0 = PP_1_1_0_default<RADIX>(in0_low, in1_low);
    ap_uint<257-1> m1 = PP_1_1_2_default<RADIX>(in0_up, in1_up);
    ap_uint<(257+1)/2> sa = in0_low + in0_up;
    ap_uint<(257+1)/2> sb = in1_low + in1_up;
    ap_uint<257+1> m2 = PP_1_1_1_default<RADIX>(sa, sb);
    ap_uint<257> t0 = m0 + m1;
    ap_uint<257+1> t1 = m2 - t0;
    ap_uint<2*(257-1)> pp_up_up = ((ap_uint<257-1 + 257-1>)m1 << (257-1)) + ((ap_uint<257+1 + (257-1)/2>)t1 << ((257-1)/2)) + m0; 
...
template <int RADIX>
ap_uint<2*128> PP_1_2_0_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*129> PP_1_2_1_default(ap_uint<129> in0, ap_uint<129> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*128> PP_1_2_2_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
ap_uint<2*256> PP_1_2_karatsuba(ap_uint<256> in0, ap_uint<256> in1) {
    ...
    ap_uint<256> m0 = PP_1_2_0_default<RADIX>(in0_low, in1_low);
    ap_uint<256> m1 = PP_1_2_2_default<RADIX>(in0_up, in1_up);
    ap_uint<256/2+1> sa = in0_low + in0_up;
    ap_uint<256/2+1> sb = in1_low + in1_up;
    ap_uint<256+2> m2 = PP_1_2_1_default<RADIX>(sa, sb);
    ap_uint<256+1> t0 = m0 + m1;
    ap_uint<256+2> t1 = m2 - t0;
...
template <int RADIX>
ap_uint<2*128> PP_2_0_0_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*129> PP_2_0_1_default(ap_uint<129> in0, ap_uint<129> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*128> PP_2_0_2_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
ap_uint<2*256> PP_2_0_karatsuba(ap_uint<256> in0, ap_uint<256> in1) {
    ...
    ap_uint<256> m0 = PP_2_0_0_default<RADIX>(in0_low, in1_low);
    ap_uint<256> m1 = PP_2_0_2_default<RADIX>(in0_up, in1_up);
    ap_uint<256/2+1> sa = in0_low + in0_up;
    ap_uint<256/2+1> sb = in1_low + in1_up;
    ap_uint<256+2> m2 = PP_2_0_1_default<RADIX>(sa, sb);
    ap_uint<256+1> t0 = m0 + m1;
    ap_uint<256+2> t1 = m2 - t0;
...
template <int RADIX>
ap_uint<2*128> PP_2_1_0_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*129> PP_2_1_1_default(ap_uint<129> in0, ap_uint<129> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*128> PP_2_1_2_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
ap_uint<2*257> PP_2_1_karatsuba_odd(ap_uint<257> in0, ap_uint<257> in1) {
    ...
    ap_uint<(257-1)/2> in1_up = i1_up >> ((257-1)/2);
    ap_uint<(257-1)/2> in1_low = (i1_up << ((257-1)/2)) >> ((257-1)/2);
    ap_uint<257-1> m0 = PP_2_1_0_default<RADIX>(in0_low, in1_low);
    ap_uint<257-1> m1 = PP_2_1_2_default<RADIX>(in0_up, in1_up);
    ap_uint<(257+1)/2> sa = in0_low + in0_up;
    ap_uint<(257+1)/2> sb = in1_low + in1_up;
    ap_uint<257+1> m2 = PP_2_1_1_default<RADIX>(sa, sb);
    ap_uint<257> t0 = m0 + m1;
    ap_uint<257+1> t1 = m2 - t0;
    ap_uint<2*(257-1)> pp_up_up = ((ap_uint<257-1 + 257-1>)m1 << (257-1)) + ((ap_uint<257+1 + (257-1)/2>)t1 << ((257-1)/2)) + m0; 
...
template <int RADIX>
ap_uint<2*128> PP_2_2_0_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*129> PP_2_2_1_default(ap_uint<129> in0, ap_uint<129> in1) {
    #pragma HLS inline
...
template <int RADIX>
ap_uint<2*128> PP_2_2_2_default(ap_uint<128> in0, ap_uint<128> in1) {
    #pragma HLS inline
...
ap_uint<2*256> PP_2_2_karatsuba(ap_uint<256> in0, ap_uint<256> in1) {
    ...
    ap_uint<256> m0 = PP_2_2_0_default<RADIX>(in0_low, in1_low);
    ap_uint<256> m1 = PP_2_2_2_default<RADIX>(in0_up, in1_up);
    ap_uint<256/2+1> sa = in0_low + in0_up;
    ap_uint<256/2+1> sb = in1_low + in1_up;
    ap_uint<256+2> m2 = PP_2_2_1_default<RADIX>(sa, sb);
    ap_uint<256+1> t0 = m0 + m1;
    ap_uint<256+2> t1 = m2 - t0;
