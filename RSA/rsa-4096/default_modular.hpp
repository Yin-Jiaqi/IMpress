...
const unsigned int RSA_SIZE=4096;
const unsigned int RADIX=128; // RSA_SIZE should be divisible by RADIX
...
void digit_multiplication(ap_uint<RADIX> x, ap_uint<RADIX> y, ap_uint<RADIX> *MSD, ap_uint<RADIX> *LSD){
    ap_uint<2*RADIX> result = (ap_uint<2*RADIX>) x * (ap_uint<2*RADIX>) y;
    *LSD = result;
    *MSD = result >> RADIX;
